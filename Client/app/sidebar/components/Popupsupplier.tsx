    ...
    return (
        <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50">
            <div className="bg-white p-8 w-3/4 h-3/4 md:w-2/3 md:h-2/3 rounded-lg shadow-xl relative">
                ...
                <div className="mt-2">
                    <h3>CompanyName & WebsiteURL</h3>
                    <div className="flex justify-between">
                    <input placeholder="Name" className="border border-blue-500 shadow-lg p-2 ml-16"></input>
                    <input placeholder="WebsiteURL" className="border border-blue-500 shadow-lg p-2 mr-16"></input>
                    </div>
                </div>
                <div className="mt-2">
                    <h3>LegalDetails</h3>
